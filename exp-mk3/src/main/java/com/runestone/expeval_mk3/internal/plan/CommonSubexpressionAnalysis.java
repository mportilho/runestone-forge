 ...
 */
record CommonSubexpressionAnalysis(Map<NodeId, Integer> memoSlotsByNodeId, int memoSlotCount) {

    static final CommonSubexpressionAnalysis EMPTY = new CommonSubexpressionAnalysis(Map.of(), 0);
