# Plano de Exploração — dynamic-filter-resolver
...
- [x] ✅ **Archaeologist** — Análise do módulo `modules.jpa`
- [x] ✅ **Archaeologist** — Análise do módulo `modules.openapi`
- [x] ✅ **Archaeologist** — Análise do módulo `test-support.performance`
