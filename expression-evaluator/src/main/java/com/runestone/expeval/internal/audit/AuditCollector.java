package com.runestone.expeval.internal.audit;
 ...
 */
public final class AuditCollector {

    private final long startNanos = System.nanoTime();
    private final List<AuditEvent> events;

    public AuditCollector(int initialCapacity, List<AuditEvent> seedEvents) {
    ...
    public ExpressionAuditTrace buildTrace() {
