 ...
 */
public final class FilterContextStack {

    public static final ThreadLocal<FilterContextStack> INSTANCE =
    ...
    public void pushMapEntry(Object key, Object value) {
        ensureCapacity();
