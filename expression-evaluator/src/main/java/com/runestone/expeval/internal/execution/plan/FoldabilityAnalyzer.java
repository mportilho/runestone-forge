...
public final class FoldabilityAnalyzer {

    private FoldabilityAnalyzer() {
    }

    public static boolean isFoldableAccess(ExecutablePropertyChain.ExecutableAccess access) {
    ...
    public static boolean isFoldableNode(ExecutableNode node, boolean allowFilterContext) {
        return switch (node) {
