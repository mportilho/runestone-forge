...
public final class ExecutionScope {
     ...
     */
    public static ExecutionScope from(Object[] sharedExternal, int internalCapacity) {
     ...
     */
    public static ExecutionScope from(Object[] overrides,
                               Object[] defaults,
     ...
     */
    public static ExecutionScope readOnly(Object[] sharedValues) {
     ...
     */
    public static ExecutionScope readOnly(Object[] overrides, Object[] defaults) {
        return new ExecutionScope(overrides, defaults, null, false, null);
    }

    public static ExecutionScope fromWithAudit(Object[] sharedExternal,
    ...
    public static ExecutionScope fromWithAudit(Object[] overrides,
                                        Object[] defaults,
                                        int internalCapacity,
                                        AuditCollector audit) {
        Objects.requireNonNull(audit, "audit must not be null");
    ...
    public static ExecutionScope readOnlyWithAudit(Object[] sharedValues, AuditCollector audit) {
    ...
    public static ExecutionScope readOnlyWithAudit(Object[] overrides,
                                            Object[] defaults,
                                            AuditCollector audit) {
        Objects.requireNonNull(audit, "audit must not be null");
     ...
     */
    public Object find(SymbolRef symbolRef) {
    ...
    public void assign(SymbolRef symbolRef, Object value) {
        if (!mutable) {
    ...
    public Object resolveDynamic(DynamicInstant kind) {
