...
public final class OperatorEvaluator {
    ...
    public static Object evaluateUnary(UnaryOperator operator, Object operand, RuntimeServices runtimeServices, MathContext mathContext) {
    ...
    public static Object evaluateBinary(BinaryOperator operator, Object left, Object right, RuntimeServices runtimeServices, MathContext mathContext) {
        return switch (operator) {
    ...
    public static Object evaluateTernary(TernaryOperator operator, Object value, Object lower, Object upper, RuntimeServices runtimeServices) {
    ...
    public static Object evaluatePostfix(PostfixOperator operator, Object operand, RuntimeServices runtimeServices, MathContext mathContext) {
