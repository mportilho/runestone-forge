...
public final class ExternalBindingPlanner {

    private ExternalBindingPlanner() {
    }

    public static Object[] seedDefaults(SemanticModel semanticModel,
    ...
    public static Map<SymbolRef, Object> seedNonOverridableConstants(SemanticModel semanticModel,
                                                              ExternalSymbolCatalog catalog,
                                                              RuntimeServices runtimeServices) {
        Objects.requireNonNull(semanticModel, "semanticModel must not be null");
        Objects.requireNonNull(catalog, "catalog must not be null");
    ...
    public static Map<String, ExternalBindingPlan> seedBindingPlans(SemanticModel semanticModel,
                                                             ExternalSymbolCatalog catalog) {
        Objects.requireNonNull(semanticModel, "semanticModel must not be null");
        Objects.requireNonNull(catalog, "catalog must not be null");
