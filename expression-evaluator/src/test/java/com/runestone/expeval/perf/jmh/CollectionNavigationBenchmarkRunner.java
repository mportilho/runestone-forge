...
public final class CollectionNavigationBenchmarkRunner {

    private CollectionNavigationBenchmarkRunner() {
    }

    public static void main(String[] args) throws Exception {
        Options options = new OptionsBuilder()
                .include(CollectionNavigationBenchmark.class.getSimpleName())
                .forks(0)
                .warmupIterations(3)
