package com.runestone.expeval.perf.jmh.startup.parsing;
...
public class ExpressionEvaluatorWarmupBenchmark {

    private static final List<Scenario> CORPUS_SCENARIOS = ExpressionEvaluatorScenarioCatalog.corpusScenarios();
    ...
    private static ParserRuleContext parseEntryPoint(ExpressionEvaluatorParser parser, EntryPoint entryPoint) {
    ...
    private static void clearSharedDfaCaches() {
        ExpressionEvaluatorLexer lexer = new ExpressionEvaluatorLexer(CharStreams.fromString(""));
    ...
    public abstract static class BaseScenarioState {
        ...
        public void resolveScenario() {
            scenario = ExpressionEvaluatorScenarioCatalog.requireScenario(scenarioName);
        }
    }
    ...
    private record ParseSession(ExpressionEvaluatorParser parser) {
    }
