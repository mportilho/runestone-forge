package com.runestone.expeval.perf.jmh.runtime.audit;
...
public class AuditOverheadBenchmark {
    ...
    public BigDecimal variableChurnNoAudit(VariableChurnAuditState state) {
        return state.expression.compute(ExpressionBenchmarkSupport.frameToMap(ExpressionBenchmarkSupport.variableFrame(state.index++)));
    }

    @Benchmark
    public AuditResult<BigDecimal> variableChurnWithAudit(VariableChurnAuditState state) {
        return state.expression.computeWithAudit(ExpressionBenchmarkSupport.frameToMap(ExpressionBenchmarkSupport.variableFrame(state.index++)));
    }
    ...
    public BigDecimal userFunctionNoAudit(UserFunctionAuditState state) {
        return state.expression.compute(ExpressionBenchmarkSupport.frameToMap(ExpressionBenchmarkSupport.userFunctionFrame(state.index++)));
    }

    @Benchmark
    public AuditResult<BigDecimal> userFunctionWithAudit(UserFunctionAuditState state) {
        return state.expression.computeWithAudit(ExpressionBenchmarkSupport.frameToMap(ExpressionBenchmarkSupport.userFunctionFrame(state.index++)));
    }
    ...
    public static class VariableChurnAuditState {
        ...
        @Setup(Level.Trial)
        public void setUp() {
            expression = ExpressionBenchmarkSupport.newVariableChurnExpression();
        }
    }
    ...
    public static class AssignedVariableAuditState {
        ...
        // Expression reuses the 12 standard variable names from ExpressionBenchmarkSupport.
    ...
    public static class UserFunctionAuditState {
        ...
        @Setup(Level.Trial)
        public void setUp() {
            expression = ExpressionBenchmarkSupport.newUserFunctionExpression();
        }
    }
}
