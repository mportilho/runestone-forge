...
import com.runestone.dynafilter.core.operation.Greater;
...
public final class SpecificationGreater extends AbstractSpecificationFilterOperation {

    public SpecificationGreater(DataConversionService conversionService) {
    ...
    Predicate createPredicate(FilterData filterData, Root<?> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        return criteriaBuilder.greaterThan(comparable(path), (Comparable) converted(filterData, path));
    }
}
